...
import { jacobi } from "@/app/script/linearMethod";
...
export default function Page() {
  ...
  const calculate = () => {
    ...
    const result = jacobi(matrixA, matrixB, initialX0);
    console.log(result);
    setAnswer(result);
  };
    ...
    <>
      <div className="mt-12 flex justify-center items-center">
        <div className="mb-16 p-8 grid grid-cols-12 border-2 border-red-400 w-1/2 gap-4">
          <div className="col-span-12 text-2xl font-bold">Jacobi iteration</div>
          <input
