...
import { inverseMatrix } from "@/app/script/linearMethod";
...
export default function Page() {
  ...
  const calculate = () => {
    ...
    const result = inverseMatrix(matrixNumberA, matrixNumberB);
    setAnswer(result);
  };
    ...
    <title>Matrix Inversion</title>
      <div className="mt-12 flex justify-center items-center">
        <div className="mb-16 p-8 grid grid-cols-12 border-2 border-red-400 w-1/2 gap-4">
          <div className="col-span-12 text-2xl font-bold">Matrix Inversion</div>
          <input
